...
newmatt$valid <- ifelse(newmatt$X1 >= 1920 & newmatt$X1 <= 2002 & newmatt$valid == TRUE, TRUE, FALSE)
newmatt$valid <- ifelse(newmatt$X2 >= 2010 & newmatt$X2 <= 2020 & newmatt$valid == TRUE, TRUE, FALSE)
newmatt$valid <- ifelse(newmatt$X3 >= 2020 & newmatt$X3 <= 2030 & newmatt$valid == TRUE, TRUE, FALSE)
ifelse(newmatt$valid == TRUE & grepl("cm", newmatt$X4) & as.numeric(str_replace_all(newmatt$X4, "[a-z]", "")) >= 150 & as.numeric(str_replace_all(newmatt$X4, "[a-z]", "")) <= 193, flag + 1, flag)
ifelse(newmatt$valid == TRUE & grepl("in", newmatt$X4) & as.numeric(str_replace_all(newmatt$X4, "[a-z]", "")) >= 59 & as.numeric(str_replace_all(newmatt$X4, "[a-z]", "")) <= 76, flag + 1, flag)
newmatt$valid <- ifelse(flag == 1, TRUE, FALSE)
newmatt$valid <- ifelse(substr(newmatt$X5, 1, 1) == "#" & grepl("[0-9a-f]", substr(newmatt$X5, 2, nchar(newmatt$X5) - 1)) & newmatt$valid == TRUE, TRUE, FALSE)
newmatt$valid <- ifelse(grepl("(amb|blu|grn|gry|grn|hzl|oth)", newmatt$X6) & newmatt$valid == TRUE, TRUE, FALSE)
